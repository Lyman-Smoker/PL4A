...
class Seven_Dataset(torch.utils.data.Dataset):
    def __init__(self, subset, multi_action, transform):
        ...
        if multi_action:
            ...
            self.class_idx = action_id  # sport class index(from 1 begin)
        

        self.score_range = score_range
        # file path
        self.data_root = data_root     # '/home/share/AQA_7'
        # self.split_path = os.path.join(self.data_root, 'Split_4', 'uniformly_averaged_split_4_train_list.mat')
        self.split_path = os.path.join(self.data_root, 'Split_4', 'uniformly_averaged_split_4_train_list.mat')     # /home/share/AQA_7/Split_4/split_4_train_list.mat
